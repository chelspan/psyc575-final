...
$$
\text{deptot}_{ti} = \beta_{0i} + \beta_{1i} \text{adltotb\_pmc}_{ti} + e_{ti}
$$

**Lvl 2:**

$$
\beta_{0i} = \gamma_{00} + \gamma_{01} \text{adltotb\_pm}_i + \gamma_{02} \text{race}_i + \gamma_{03} \text{adltotb\_pm}_i \times
 \text{race}_i + u_{0i}
$$
